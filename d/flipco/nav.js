(function(){
  ...
  function updateHeaderScroll(){const h=document.querySelector('.site-header');if(!h)return;const f=()=>h.classList.toggle('is-scrolled',window.scrollY>18);f();window.addEventListener('scroll',f,{passive:true})}
